...
const getFilteredGuitarsByPrice = (guitars : Guitars, minPrice: number, maxPrice: number): Guitars => guitars.filter((guitar) => guitar.price >= minPrice && guitar.price <= maxPrice);
...
const getFilteredGuitarsByStrings = (guitars: Guitars, guitarStrings: Array<number>): Guitars => guitars.filter((guitar) => guitarStrings.includes(guitar.stringCount));

const getFilteredGuitarsByAllFilters = (guitars: Guitars, minPrice: number, maxPrice: number, guitarTypes: Array<string>, guitarStrings: Array<number>): Guitars => {
...
export {getFilteredGuitarsByPrice, getFilteredGuitarsByTypes, getFilteredGuitarsByStrings, getAvailableStringCount, getFilteredGuitarsByAllFilters, getPagesCount};
