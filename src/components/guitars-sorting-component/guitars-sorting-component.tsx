  ...
  return (
    <div className="catalog-sort">
      ...
      <div className="catalog-sort__type">
        <button className={`catalog-sort__type-button ${(sortType === SortType.Price)&&'catalog-sort__type-button--active'}`} aria-label="по цене" tabIndex={-1} data-testid="price" onClick={()=>{handleChangeSortTypeByPrice(SortType.Price);}}>по цене
        </button>
      ...
      <div className="catalog-sort__order">
        <button className={`catalog-sort__order-button catalog-sort__order-button--up ${(sortDirection === SortDirection.Ascension)&&'catalog-sort__order-button--active'}`} aria-label="По возрастанию" data-testid="ascension" tabIndex={-1} onClick={()=>{handleChangeSortDirectionByAsc(SortDirection.Ascension);}}></button>
